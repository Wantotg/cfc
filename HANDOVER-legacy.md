...
> the new handover's one-liners is here, and because deleting a record of why
> things are the way they are is how they get re-decided. Anything below that
> disagrees with the code is stale; the code wins, then `HANDOVER.md`, then this.
