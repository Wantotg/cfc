...
the scope.** Something outside it that turns up goes to `BACKLOG.md` or
`BUGS.md` with an id — not into this commit.

## What leaves

- The code, committed and pushed, with its `CHANGELOG.md` entry **in the same
